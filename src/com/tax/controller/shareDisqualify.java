...
/**
 * Servlet implementation class shareDisqualify
 * -经验分享审核拒绝
 */
@WebServlet("/shareDisqualify")
public class shareDisqualify extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public shareDisqualify() {
        super();
